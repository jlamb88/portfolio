...
import empireScreenshot from './empire-screenshot.webp'
import empireScreenshotMobile from './empire-screenshot-m.webp'
import foresomeScreenshot from './foresome-screenshot.webp'
import foresomeScreenshotMobile from './foresome-screenshot-m.webp'
import weatherScreenshot from './weather-screenshot.webp'
import weatherScreenshotMobile from './weather-screenshot-m.webp'
import glissonScreenshot from './glisson-screenshot.webp'
import glissonScreenshotMobile from './glisson-screenshot-m.webp'
import conjureScreenshot from './conjure-screenshot.webp'
import conjureScreenshotMobile from './conjure-screenshot-m.webp'

const EmpireScreenshot = ({ className }) => (
    <picture >
        <source
            media='(min-width: 431px)'
            srcSet={empireScreenshot}
        />
        <source
            media='(max-width: 430px)'
            srcSet={empireScreenshotMobile}
        />

        <img
            width='1000'
            height='565'
            src={empireScreenshot}
            className={className}
            alt='Screenshot of Empire Cheesecakes website'
            loading='lazy'
        />
    </picture>
)
const GlissonScreenshot = ({ className }) => (
    <picture >
        <source
            media='(min-width: 431px)'
            srcSet={glissonScreenshot}
        />
        <source
            media='(max-width: 430px)'
            srcSet={glissonScreenshotMobile}
        />

        <img
            width='1000'
            height='565'
            src={glissonScreenshot}
            className={className}
            alt='Screenshot of Glisson Camps website'
            loading='lazy'
        />
    </picture>
)
const ForesomeScreenshot = ({ className }) => (
    <picture>
        <source
            media='(min-width: 431px)'
            srcSet={foresomeScreenshot}
        />
        <source
            media='(max-width: 430px)'
            srcSet={foresomeScreenshotMobile}
        />

        <img
            width='1000'
            height='565'
            src={foresomeScreenshot}
            className={className}
            alt='Screenshot of Foresome website'
            loading='lazy'
        />
    </picture>
)
const WeatherNowScreenshot = ({ className }) => (
    <picture>
        <source
            media='(min-width: 431px)'
            srcSet={weatherScreenshot}
        />
        <source
            media='(max-width: 430px)'
            srcSet={weatherScreenshotMobile}
        />
        ...
        <img
            ...
            className={className}
            alt='Screenshot of Weather Now website'
            loading='lazy'
        />
    </picture>
)
const ConjureScreenshot = ({ className }) =>
(
    <picture>
        <source
            media='(min-width: 431px)'
            srcSet={conjureScreenshot}
        />
        <source
            media='(max-width: 430px)'
            srcSet={conjureScreenshotMobile}
        />

        <img
            width='1000'
            height='565'
            src={conjureScreenshot}
            className={className}
            alt='Screenshot of Conjure Yoga website'
            loading='lazy'
        />
    </picture>
)
const GithubIcon = ({ width = "48", height = "48", color = "var(--text-color)" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" style={{ width: width, height: height }} aria-label='Github repository'>
...
const LinkedInIcon = ({ width = "36", height = "36", color = "var(--text-color)" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" style={{ width: width, height: height }} aria-label='Linked In Button' >
...
const EmailIcon = ({ width = "50", height = "64", color = "var(--text-color)" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 500 640" style={{ width: width, height: height }} aria-label='Email Icon'>
        <style type="text/css">
            {`.st0{display:none;}
        .st1{display:inline;} 
...
export { EmpireScreenshot, ForesomeScreenshot, WeatherNowScreenshot, GlissonScreenshot, ConjureScreenshot, GithubIcon, LinkedInIcon, EmailIcon, MobileGithub, MobileLink }
